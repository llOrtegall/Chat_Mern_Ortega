export const Avatar = ({ userId, email, online }: { userId: string, email: string, online: boolean }) => {
  ...
  return (
    <div className={'w-8 h-8 relative rounded-full flex items-center ' + color}>
      <span className='w-full text-center font-semibold opacity-85'>{email[0].toUpperCase()}</span>
      {
        online === true
